 ...
 */
function sector(v: {
  ros: BenchmarkRazon; roe: BenchmarkRazon; roic: BenchmarkRazon
  ctoVentas: BenchmarkRazon; ventaNomina: BenchmarkRazon; deudaUtilidad: BenchmarkRazon
...
const DATOS: Record<string, Fila> = {
  'Manufactura y metalmecánica': sector({
    ros: b(0.085, 0.045, 0.130), roe: b(0.125, 0.070, 0.190), roic: b(0.090, 0.050, 0.135),
    ctoVentas: b(0.220, 0.140, 0.310), ventaNomina: b(5.5, 3.6, 8.2), deudaUtilidad: b(2.0, 0.9, 3.4),
  ...
  'Automotriz y autopartes': sector({
    ros: b(0.065, 0.035, 0.100), roe: b(0.110, 0.060, 0.165), roic: b(0.080, 0.045, 0.120),
    ctoVentas: b(0.180, 0.110, 0.260), ventaNomina: b(7.0, 4.5, 10.5), deudaUtilidad: b(2.2, 1.1, 3.6),
  ...
  'Alimentos y bebidas': sector({
    ros: b(0.110, 0.060, 0.170), roe: b(0.150, 0.090, 0.220), roic: b(0.110, 0.065, 0.160),
    ctoVentas: b(0.140, 0.080, 0.220), ventaNomina: b(6.5, 4.0, 9.8), deudaUtilidad: b(2.0, 0.8, 3.2),
  ...
  'Construcción e infraestructura': sector({
    ros: b(0.070, 0.030, 0.120), roe: b(0.110, 0.050, 0.180), roic: b(0.075, 0.035, 0.120),
    ctoVentas: b(0.250, 0.150, 0.380), ventaNomina: b(4.5, 2.9, 6.8), deudaUtilidad: b(2.8, 1.3, 4.6),
  ...
  'Inmobiliario y desarrollo': sector({
    ros: b(0.180, 0.100, 0.280), roe: b(0.095, 0.050, 0.150), roic: b(0.065, 0.035, 0.100),
    ctoVentas: b(0.450, 0.250, 0.700), ventaNomina: b(9.0, 5.0, 15.0), deudaUtilidad: b(4.0, 2.0, 6.5),
  ...
  'Comercio mayorista y distribución': sector({
    ros: b(0.040, 0.020, 0.070), roe: b(0.120, 0.070, 0.180), roic: b(0.085, 0.050, 0.125),
    ctoVentas: b(0.170, 0.100, 0.250), ventaNomina: b(9.0, 5.5, 14.0), deudaUtilidad: b(2.2, 1.0, 3.6),
  ...
  'Comercio minorista': sector({
    ros: b(0.060, 0.030, 0.095), roe: b(0.150, 0.090, 0.220), roic: b(0.105, 0.060, 0.150),
    ctoVentas: b(0.080, 0.020, 0.150), ventaNomina: b(7.5, 4.8, 11.5), deudaUtilidad: b(1.8, 0.7, 3.0),
  ...
  'Transporte y logística': sector({
    ros: b(0.090, 0.045, 0.145), roe: b(0.125, 0.070, 0.185), roic: b(0.080, 0.045, 0.120),
    ctoVentas: b(0.100, 0.050, 0.170), ventaNomina: b(3.8, 2.4, 5.6), deudaUtilidad: b(2.8, 1.4, 4.5),
  ...
  'Agroindustria y agropecuario': sector({
    ros: b(0.080, 0.035, 0.135), roe: b(0.105, 0.050, 0.165), roic: b(0.070, 0.035, 0.110),
    ctoVentas: b(0.300, 0.180, 0.450), ventaNomina: b(5.0, 3.0, 7.8), deudaUtilidad: b(2.6, 1.2, 4.3),
  ...
  'Energía y combustibles': sector({
    ros: b(0.055, 0.025, 0.100), roe: b(0.110, 0.055, 0.175), roic: b(0.080, 0.040, 0.125),
    ctoVentas: b(0.120, 0.060, 0.200), ventaNomina: b(12.0, 6.5, 20.0), deudaUtilidad: b(3.0, 1.5, 5.0),
  ...
  'Minería y extracción': sector({
    ros: b(0.200, 0.100, 0.320), roe: b(0.120, 0.060, 0.190), roic: b(0.095, 0.050, 0.145),
    ctoVentas: b(0.200, 0.120, 0.300), ventaNomina: b(4.5, 2.8, 7.0), deudaUtilidad: b(2.0, 0.8, 3.4),
  ...
  'Química y plásticos': sector({
    ros: b(0.095, 0.050, 0.145), roe: b(0.120, 0.070, 0.180), roic: b(0.090, 0.050, 0.135),
    ctoVentas: b(0.220, 0.140, 0.320), ventaNomina: b(6.0, 3.8, 9.0), deudaUtilidad: b(2.4, 1.1, 3.9),
  ...
  'Textil, calzado y confección': sector({
    ros: b(0.055, 0.020, 0.095), roe: b(0.095, 0.040, 0.155), roic: b(0.065, 0.030, 0.105),
    ctoVentas: b(0.280, 0.170, 0.410), ventaNomina: b(4.0, 2.5, 6.0), deudaUtilidad: b(2.5, 1.1, 4.2),
  ...
  'Farmacéutica y dispositivos médicos': sector({
    ros: b(0.140, 0.080, 0.210), roe: b(0.155, 0.090, 0.230), roic: b(0.115, 0.065, 0.170),
    ctoVentas: b(0.300, 0.190, 0.430), ventaNomina: b(5.5, 3.4, 8.4), deudaUtilidad: b(1.6, 0.6, 2.8),
  ...
  'Salud y servicios hospitalarios': sector({
    ros: b(0.120, 0.065, 0.185), roe: b(0.130, 0.070, 0.195), roic: b(0.090, 0.050, 0.135),
    ctoVentas: b(0.150, 0.080, 0.240), ventaNomina: b(2.8, 1.9, 4.1), deudaUtilidad: b(2.2, 1.0, 3.7),
  ...
  'Educación y capacitación': sector({
    ros: b(0.130, 0.070, 0.200), roe: b(0.140, 0.080, 0.210), roic: b(0.100, 0.055, 0.150),
    ...
    ventaNomina: b(2.2, 1.5, 3.2), deudaUtilidad: b(1.5, 0.5, 2.6),
  ...
  'Servicios financieros y seguros': sector({
    ros: b(0.220, 0.120, 0.340), roe: b(0.165, 0.100, 0.240),
  ...
  'Tecnología y software': sector({
    ros: b(0.120, 0.050, 0.210), roe: b(0.145, 0.070, 0.230), roic: b(0.120, 0.060, 0.190),
    ctoVentas: b(0.120, 0.040, 0.210), ventaNomina: b(2.5, 1.7, 3.8), deudaUtilidad: b(1.2, 0.3, 2.3),
  ...
  'Turismo, hotelería y restaurantes': sector({
    ros: b(0.110, 0.050, 0.180), roe: b(0.115, 0.055, 0.185), roic: b(0.075, 0.035, 0.120),
    ...
    ventaNomina: b(3.2, 2.1, 4.8), deudaUtilidad: b(3.0, 1.4, 5.0),
  ...
  'Servicios profesionales y consultoría': sector({
    ros: b(0.140, 0.070, 0.220), roe: b(0.180, 0.100, 0.270), roic: b(0.150, 0.080, 0.230),
    ctoVentas: b(0.180, 0.100, 0.280), ventaNomina: b(1.9, 1.4, 2.7), deudaUtilidad: b(1.0, 0.2, 2.0),
